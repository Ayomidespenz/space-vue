      ...
      <div class="fles">
        <div class="btn-group">
          <button
            ...
            :class="currentIndex === index ? 'btn-primary' : 'btn-secondary'"
        ...
        <div class="desc">
          ...
          <h2 class="display-5 mb-5 ">{{ currentTech.name }}</h2>
          <p class="lead">{{ currentTech.description }}</p>
        </div>
      </div>
    </div>
    <div id="part2">
...
export default {
  ...
  computed: {
    currentTech() {
      return this.technology[this.currentIndex];
    },
  },
  methods: {
